...
class MatchdayPostView(APIView):
    """Simple view for generating matchday posts with fixture details."""
    permission_classes = [IsAuthenticated]
    ...
    def post(self, request):
        ...
        try:
            ...
            try:
                ...
                return Response(
                    {"error": "Matchday template not found for this club."},
                    status=status.HTTP_404_NOT_FOUND,
                )
    ...
    def _generate_matchday_post(self, match: Match, template: Template, club: Club) -> Dict[str, Any]:
        ...
        for element_key, element_config in elements.items():
            ...
            try:
                ...
                # Get font (you'll need to implement get_font function)
                try:
                    font = get_font(font_family, font_size, font_weight, font_style)
                except:
