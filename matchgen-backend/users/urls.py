...
from .views import (
    ...
    AdminUploadPostView,
    AdminPlayerTaskListView,
    AdminUploadPlayerImageView,
    ClubCreateView,
    ClubUpdateView,
    ClubDeleteView,
    TeamManagementView,
...
urlpatterns = [
    ...
    path('admin/player-tasks/', AdminPlayerTaskListView.as_view(), name='admin_player_tasks'),
    path('admin/upload-player-image/', AdminUploadPlayerImageView.as_view(), name='admin_upload_player_image'),
